    ...
    public partial class frmCategory : Form
    {
        ...
        private void delete_records()
        {
            ...
            try
            {
                ...
                {
                    st1 = lblUser.Text;
                    st2 = "deletada a categoria '" + txtCategoryName.Text + "'";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Informe o nome da categoria", "", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtCategoryName.Focus();
                return;
            }
            try
            {
                ...
                if (cc.rdr.Read())
                {
                    MessageBox.Show("Nome da Categoria já existe", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtCategoryName.Text = "";
                    txtCategoryName.Focus();
                    if ((cc.rdr != null))
                    {
                ...
                cc.con.Close();
                st1 = lblUser.Text;
                st2 = "incluida a nova categoria '" + txtCategoryName.Text + "'";
                cf.LogFunc(st1,System.DateTime.Now,st2);
                Autocomplete();
                GetData();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cc.con.Close();
                st1 = lblUser.Text;
                st2 = "atualizada a categoria '" + txtCategoryName.Text + "'";
                cf.LogFunc(st1, System.DateTime.Now, st2);
                Autocomplete();
                GetData();
                btnUpdate.Enabled = false;
